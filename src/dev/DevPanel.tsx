...
function toStyle(v: Record<string, any>): GlobeStyle {
  return {
    ...
    beams: {
      ...
      width: v.bWidth, depthRatio: v.bDepthRatio, faceShade: v.bFaceShade, hideEndOn: v.bHideEndOn, widthTaper: v.bWidthTaper, fade: v.bFade, rise: v.bRise, riseEase: v.bRiseEase, riseSpan: v.bRiseSpan,
      shrink: v.bShrink, shrinkEase: v.bShrinkEase,
      shrinkDelay: v.bShrinkDelay, shrinkSpan: v.bShrinkSpan,
      ...
      lengthByIntensity: v.bLengthByIntensity, size: v.bSize, opacity: v.bOpacity,
      lifetime: v.bLifetime, additive: v.bAdditive, dimFactor: v.bDimFactor,
...
function toControls(s: GlobeStyle): Record<string, any> {
  return {
    ...
    bRise: s.beams.rise, bRiseEase: s.beams.riseEase, bRiseSpan: s.beams.riseSpan,
    bTrail: s.beams.trail,
    bShrink: s.beams.shrink, bShrinkEase: s.beams.shrinkEase,
    bShrinkDelay: s.beams.shrinkDelay, bShrinkSpan: s.beams.shrinkSpan,
    ...
    bLifetime: s.beams.lifetime, bAdditive: s.beams.additive, bDimFactor: s.beams.dimFactor,
    ...
    Beams: folder(
      {
        ...
        bRise: { value: i.beams.rise, min: 0, max: 1, step: 0.01, label: "grow-in amount" },
        bRiseSpan: { value: i.beams.riseSpan, min: 0.02, max: 1, step: 0.01, label: "grow-in duration",
          render: (get: Get) => get("Beams.bRise") > 0 },
        bRiseEase: { value: i.beams.riseEase, options: ["linear", "easeOut", "easeIn", "elastic"], label: "grow-in easing",
          render: (get: Get) => get("Beams.bRise") > 0 },
        bShrink: { value: i.beams.shrink, min: 0, max: 1, step: 0.01, label: "shrink over life" },
        bShrinkDelay: { value: i.beams.shrinkDelay, min: 0, max: 10, step: 0.05,
          label: "hold before shrinking (s)", render: (get: Get) => get("Beams.bShrink") > 0 },
        bShrinkSpan: { value: i.beams.shrinkSpan, min: 0.02, max: 1, step: 0.01,
          label: "shrink duration", render: (get: Get) => get("Beams.bShrink") > 0 },
        bShrinkEase: { value: i.beams.shrinkEase, options: ["linear", "easeOut", "easeIn", "elastic"],
          label: "shrink easing", render: (get: Get) => get("Beams.bShrink") > 0 },
        ...
        bLifetime: { value: i.beams.lifetime, min: 0.2, max: 60, step: 0.1, label: "lifetime (s)" },
