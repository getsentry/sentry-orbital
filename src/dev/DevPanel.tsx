...
function toStyle(v: Record<string, any>): GlobeStyle {
  return {
    ...
    beams: {
      ...
      shrinkStart: v.bShrinkStart, shrinkSpan: v.bShrinkSpan,
...
function toControls(s: GlobeStyle): Record<string, any> {
  return {
    ...
    bShrinkStart: s.beams.shrinkStart, bShrinkSpan: s.beams.shrinkSpan,
    ...
    Beams: folder(
      {
        ...
        bShrinkStart: { value: i.beams.shrinkStart, min: 0, max: 1, step: 0.01,
          label: "shrink starts at", render: (get: Get) => get("Beams.bShrink") > 0 },
