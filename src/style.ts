...
export const PRESETS: Record<string, GlobeStyle> = {
  ...
  // Saved from the style panel, so this is the full object rather than a diff:
  ...
  "CRT 2": merge(DEFAULT_STYLE, {
    background: { color: "#000a61" },
    globe: {
      visible: true, mode: "solid", material: "basic", color: "#1500ff", landColor: "#73c792",
    ...
    stars: {
      enabled: true, color: "#fbfcb3", count: 2900, radius: 20, depth: 200, factor: 5.6,
      saturation: 0, fade: true, speed: 0.1,
    },
    clouds: {
      enabled: true, style: "blocky", color: "#ffffff", opacity: 0.69, altitude: 0.002,
      drift: 0.006, seed: 630, lit: false, additive: false, coverage: 0.45, softness: 0.28,
      scale: 3.2, detail: 4, clusters: 36, blockSize: 0.021, spread: 1.5, puffiness: 3,
